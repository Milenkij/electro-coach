...
1. Прочитай `business-model/SKILL.md` целиком и следуй методологии оттуда (9 блоков Остервальдера, templates, best practices).
...
- Скил **автономен**: не связан с `pipeline-templates/`, `runs/` или `knowledge/`. Не пиши ничего в эти папки.
